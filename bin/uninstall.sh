...
ac_step "Skills de ingeniería (superpowers + swebok + book-to-skill + conventional-commits + skill-mcp-builder + no-ai-slop + nombres legados)"
for s in superpowers solid design-patterns conventional-commits architecture-patterns architecture-principles swebok book-to-skill skill-mcp-builder no-ai-slop rituales; do
